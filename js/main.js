...
const careerData = [
    {
        ...
        title: "副キャプテンとしての原点",
        content: "中学・高校でのサッカー経験。怪我による挫折から「個々を支え、和を創る」サポート型リーダーシップを学びました。これが今の対人支援のルーツです。",
        icon: "trophy",
        color: "text-blue-500",
        bgColor: "bg-blue-50",
    ...
    },
    {
        ...
        content: "首席卒業後、師匠の元で日夜研鑽。某研究会所属。自費でポータブルエコーを購入してまで『視覚的な根拠』を追求。この「徹底的に突き詰める姿勢」は私の最大の武器です。",
        icon: "stethoscope",
    ...
    },
    {
        ...
        content: "営業へ転身し社内1位を達成。お客様の潜在ニーズを聞き出し、論理的に解決策を提案する力、そして目標をやり抜く完遂力を磨きました。",
        icon: "users",
    ...
    },
    {
        ...
        title: "ITで多くの人を支える挑戦",
        content: "現在は、N予備校にて猛勉強。平行して通信大学にてデータサイエンスを学びます。独学やスクールにてアプリ開発を学び、「予定調整くん」を自作。貴社の戦力になることをお約束します。",
        icon: "cpu",
